...
const ActivateProductModal: React.FC<ModalProps> = ({
  visible,
  setVisible,
  children,
}) => {
      ...
      <Dialog onClose={() => setVisible(false)} static={true} open={visible}>
        ...
        >
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            <DialogPanel className="relative h-full xl:h-[500px] w-full mt-auto sm:mt-0 sm:w-[650px]  flex bg-white k rounded-sm shadow-md">
